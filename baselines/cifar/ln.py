...
""" Logit-Normal Wide ResNet 28-2 on CIFAR-10/100 trained with MAP.
    This code is based on implementations of baselines in baselines/cifar/ 
...
flags.DEFINE_enum('corruption_type', 'asym',
                  enum_values=['sym', 'asym', 'worst', 'aggre',
        ...
        def step_fn(inputs):
            ...
            with tf.GradientTape(persistent=True) as tape:
                ...
                logit_normal = _create_logitnormal(
                    loc, scale, FLAGS.min_scale, num_classes, smoothed_targets)
    ...
    def test_step(iterator, dataset_split, dataset_name, num_steps):
        ...
        def step_fn(inputs):
            ...
            if dataset_name == 'clean':
                ...
                metrics[f'validation/accuracy_nl'].update_state(
                    labels_noisy, probs)
